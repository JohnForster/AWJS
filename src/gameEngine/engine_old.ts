...
export default class Engine {
  ...
  async loadSprites () {
    ...
    const spriteSheet = <HTMLImageElement> await Engine.addImageProcess('assets/spriteSheet.png')
    const UISprites = <HTMLImageElement> await Engine.addImageProcess('assets/UISprites.png')
